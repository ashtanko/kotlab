...
* 96,298 source lines of code (sloc)

* 68,513 logical lines of code (lloc)

* 44,466 comment lines of code (cloc)
...
generated with [detekt version 1.23.0](https://detekt.dev/) on 2023-08-27 13:31:10 UTC
