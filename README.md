...
### Metrics
```text
13352 number of properties
9194 number of functions
8170 number of classes
184 number of packages
3122 number of kt files
```


### Complexity Report
```text
229266 lines of code (loc)
143104 source lines of code (sloc)
104858 logical lines of code (lloc)
61504 comment lines of code (cloc)
22492 cyclomatic complexity (mcc)
18807 cognitive complexity
